...
public interface DrivetrainSettings {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = Math.toRadians(0); // 119
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(-82); // -82
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = Math.toRadians(0); // 193
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(19.2); // 19.2
