...
public class NemesisCANCoderBuilder implements RobotMap{
    private Direction direction = Direction.COUNTER_CLOCKWISE;
    private int periodMilliseconds = 10;

    public NemesisCANCoderBuilder withReadingUpdatePeriod(int periodMilliseconds) {
        this.periodMilliseconds = periodMilliseconds;
        return this;
    }

    public NemesisCANCoderBuilder withDirection(Direction direction) {
