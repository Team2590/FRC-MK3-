...
public final class NemesisDriveFactoryBuilder implements RobotMap{
    ...
    public NemesisDriveFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public NememsisDriveFactory<?, Integer> build() {
        return new FactoryImplementation();
    }

    public NemesisDriveFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    private class FactoryImplementation implements NememsisDriveFactory<ControllerImplementation, Integer> {
        @Override
        public ControllerImplementation create(Integer driveConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            TalonFX motor = new TalonFX(driveConfiguration, CAN_BUS);
    ...
    private class ControllerImplementation implements DriveController {
        ...
        private final double nominalVoltage = hasVoltageCompensation() ? NemesisDriveFactoryBuilder.this.nominalVoltage : 12.0;
