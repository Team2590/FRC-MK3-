...
public class NemesisModuleFactory<DriveConfiguration, SteerConfiguration> {
    private final ModuleConfiguration moduleConfiguration;
    private final NememsisDriveFactory<?, DriveConfiguration> driveControllerFactory;
    private final NemesisSteerFactory<?, SteerConfiguration> steerControllerFactory;

    public NemesisModuleFactory(ModuleConfiguration moduleConfiguration,
        NememsisDriveFactory<?, DriveConfiguration> driveControllerFactory,
        NemesisSteerFactory<?, SteerConfiguration> steerControllerFactory) {
