...
public final class NemesisSteerFactoryBuilder implements RobotMap {
    private class FactoryImplementation<T> implements NemesisSteerFactory<ControllerImplementation, Falcon500SteerConfiguration<T>> {
        ...
        public void addDashboardEntries(ShuffleboardContainer container, ControllerImplementation controller) {
            NemesisSteerFactory.super.addDashboardEntries(container, controller);
        ...
        public ControllerImplementation create(Falcon500SteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            TalonFX motor = new TalonFX(steerConfiguration.getMotorPort(), CAN_BUS);
    ...
    public NemesisSteerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public NemesisSteerFactoryBuilder withMotionMagic(double velocityConstant, double accelerationConstant, double staticConstant) {
    ...
    public NemesisSteerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public NemesisSteerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    public <T> NemesisSteerFactory<ControllerImplementation, Falcon500SteerConfiguration<T>> build(AbsoluteEncoderFactory<T> absoluteEncoderFactory) {
